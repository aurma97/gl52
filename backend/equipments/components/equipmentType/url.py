...
urlpatterns = [
    ...
    path('', EquipmentTypeAPIView.as_view(), name="type"),
    
    # url = http://localhost:8000/api/manage/type-of-equipments/show/<pk>
    path('show/<pk>', EquipmentTypeRudView.as_view(), name="type"),

    # url = http://localhost:8000/api/manage/type-of-equipments/update-or-delete/<pk>
    path('update-or-delete/<pk>', EquipmentTypeRudView.as_view(), name="type"),
]