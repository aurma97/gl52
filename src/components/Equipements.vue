                ...
                <template slot-scope="props">
                    ...
                    <b-table-column sortable centered>
                        <b-field grouped group-multiline>
                            ...
                            <div>
                                <button class="button is-danger" @click="isCardModalActive = true"><i class="fas fa-trash"></i></button>
                            </div>
                        </b-field>
                    </b-table-column>

                    <b-table-column sortable centered v-if="isCardModalActive">
                        <span>
                            <button class="button is-danger" @click="deleteEquipment(props.row.id)">Confirmation suppression</button>
                        </span>
                    </b-table-column>
                </template>
...
import { mapState, mapActions } from 'vuex'
    ...
    export default {
        ...
        computed: mapState({
            ...
            errors: state => state.equipments.errors,
        }),
        methods: {
